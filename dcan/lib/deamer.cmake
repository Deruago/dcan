...
file(GLOB_RECURSE SOURCE_LIST "${dcan_SOURCE_DIR}/lib/*.cpp")
file(GLOB_RECURSE HEADER_LIST "${dcan_SOURCE_DIR}/include/*.h")

# Root library extension
dcan_root_library_extend("dcan" "${dcan_SOURCE_DIR}/extern" "${dcan_SOURCE_DIR}/include" "${SOURCE_LIST}")
